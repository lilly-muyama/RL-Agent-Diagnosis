...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--eval_type', help='test or validation')
    parser.add_argument('-f', '--model_name', help='filename of the model')
    ...
    dqn_avg_length = utils.get_avg_length_reward(dqn_test_df)
