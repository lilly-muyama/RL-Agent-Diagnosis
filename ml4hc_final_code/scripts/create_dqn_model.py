...
if __name__=='__main__':
    ...
    parser.add_argument('-m', '--model_type', help='dqn or ddq or dueling_dqn or dueling_ddqn', required=True)
    parser.add_argument('-p', '--prioritized_replay', help ='yes or no', default='yes')  
    parser.add_argument('-t', '--steps', help='Number of timetseps to train the model', required=True, type=int)
    ...
    #steps is an arg, filename of model is an arg, method used should be based on an arg
    ...
    elif args.model_type == 'dueling ddqn':
